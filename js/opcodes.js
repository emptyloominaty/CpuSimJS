...
let opCodeList = {
    ...
    68: {bytes:2,name:"CBT8",cycles:11},  //Convert 1byte to 8bits  r1 -> r1,r2,r3,r4,r5,r6,r7,r8
    69: {bytes:2,name:"C8TB",cycles:7},  //Convert 8bits to 1byte  r1,r2,r3,r4,r5,r6,r7,r8 -> r1
